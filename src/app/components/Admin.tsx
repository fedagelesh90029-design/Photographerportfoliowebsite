...
import { Trash2, Plus, Upload, Image as ImageIcon, FolderTree, MessageSquare, Check } from "lucide-react";
...
export function Admin() {
  ...
  const handleUploadPhoto = async () => {
    ...
    try {
      ...
      await axios.post("/api/photos", { url, category: newPhotoCategory });
